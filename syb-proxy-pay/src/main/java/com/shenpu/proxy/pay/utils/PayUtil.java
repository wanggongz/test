...
public class PayUtil {
	 ...
	 * @return boolean
	 */
	public static boolean judgeWechatNotifySign(String characterEncoding, SortedMap<String, String> paramsMap) {
		...
		//sb.append("key=" + Settings.WX_APP_SECRET);
	 ...
	 * @return
	 */
	public static String createWechatSign(String characterEncoding, SortedMap<Object, Object> paramsMap) {
		StringBuffer sb = new StringBuffer();
	...
	/**
	 * 将请求微信参数转换为xml格式的string
	 * @param paramsMap
	 * @return
	 */
	public static String dealWechatParameters2XmlStr(SortedMap<Object, Object> paramsMap) {
		StringBuffer sb = new StringBuffer();
		sb.append("<xml>");
		Set<Entry<Object, Object>> es = paramsMap.entrySet();
		Iterator<Entry<Object, Object>> it = es.iterator();
	 ...
	 * @return
	 */
	public static String dealAntParameters2LinkStr(SortedMap<Object, Object> parametersMap) {
		StringBuffer sb = new StringBuffer();
	 ...
	 * @return
	 */
	public static SortedMap<String, String> dealAntNotify2Map(HttpServletRequest request) {
	 ...
	 * @return
	 */
	public static String dealAntParameters2UrlStr(SortedMap<String, String> paramsMap) {
		StringBuffer sb = new StringBuffer();
		Set<Entry<String, String>> es = paramsMap.entrySet();
		Iterator<Entry<String, String>> it = es.iterator();
		while (it.hasNext()) {
