...
public class Appnt implements Serializable{
    ...
    public void setAppntId(String appntId) {
        this.appntId = appntId == null ? null : appntId.trim();
    }
    ...
    public void setIsStatutory(String isStatutory) {
        this.isStatutory = isStatutory == null ? null : isStatutory.trim();
    }
	...
	public String toString() {
		return "Appnt [appntId=" + appntId + ", policyNo=" + policyNo + ", orderNo=" + orderNo + ", applyNo=" + applyNo
				+ ", appntName=" + appntName + ", sex=" + sex + ", age=" + age + ", birthday=" + birthday + ", idType="
				...
				+ mapCoordinates + ", degree=" + degree + ", marriage=" + marriage + ", yearIncom=" + yearIncom
				+ ", height=" + height + ", weight=" + weight + ", status=" + status + ", insertTime=" + insertTime
				+ ", updateTime=" + updateTime + ", isStatutory=" + isStatutory + ", isself=" + isself + ", idTypeName="
				+ idTypeName + ", marriageName=" + marriageName + ", degreeName=" + degreeName + ", cityIdName="
				+ cityIdName + ", countyIdName=" + countyIdName + ", provIdName=" + provIdName + ", nativeplaceName="
				+ nativeplaceName + "]";
	}
